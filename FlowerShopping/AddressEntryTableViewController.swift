...
class AddressEntryTableViewController: UITableViewController, UIPickerViewDelegate, UIPickerViewDataSource, SwitchTableViewCellDelegate, TextEntryTableViewCellDelegate {
    ...
    override func viewDidLoad() {
        ...
        var fields = [contactFirstNameFieldIdentifier, contactLastNameFieldIdentifier, address1FieldIdentifier, address2FieldIdentifier, cityFieldIdentifier]
        
        if !isShippingAddress {
            // Set-up extra billing address fields...
            fields = [contactEmailFieldIdentifier, contactFirstNameFieldIdentifier, contactLastNameFieldIdentifier, address1FieldIdentifier, address2FieldIdentifier, cityFieldIdentifier]
            
            billingDictionary = Dictionary<String, String>()
            
            self.title = "Địa chỉ thanh toán"
            
        } else {
            shippingDictionary = Dictionary<String, String>()
            
            self.title = "Địa chỉ giao hàng"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if ((indexPath as NSIndexPath).row == contactFieldsArray.count && !isShippingAddress) {
            ...
            cell.switchLabel?.text = "Địa chỉ gửi hàng như thanh toán?"
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        let selectedCountry = countryArray![row]["name"]!
         print("havadu: selectedCountry= ",selectedCountry)
    ...
    func validateData() -> Bool {
        ...
        let requiredFields = [contactFirstNameFieldIdentifier, contactLastNameFieldIdentifier, address1FieldIdentifier, cityFieldIdentifier]
    ...
    func getAddressDict() -> Dictionary<String, String> {
        ...
        //address2 = address2 + ", " +  sourceDict[stateFieldIdentifier]!
         address2 = address2 + ", " +  "Shiping"
        
        formattedDict[countryFieldIdentifier] = country
        //formattedDict[postcodeFieldIdentifier] = sourceDict[postcodeFieldIdentifier]
        formattedDict[postcodeFieldIdentifier] = "2300"
        print("havadu: formattedDict[postcodeFieldIdentifier]= ",formattedDict[postcodeFieldIdentifier])
